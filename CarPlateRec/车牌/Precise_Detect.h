...
PRECISE_DETECTDLL	bool CarPlateRecognition(char Filepath[], vector<string>&Carplates ,  
	vector<string>&Platecolor , vector<Rect> &Positions, bool model ) ;
...
int Precise_detect(/*Mat img,*/Mat gray,Mat color,int whitebody,int colnum,int vnum,int count,int snum,int cons,int &st,int retest,vector<Mat> &block);
