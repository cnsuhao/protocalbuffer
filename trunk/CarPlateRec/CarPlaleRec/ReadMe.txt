========================================================================
    动态链接库：CarPlaleRec 项目概述
========================================================================

应用程序向导已为您创建了此 CarPlaleRec DLL。

本文件概要介绍组成 CarPlaleRec 应用程序的每个文件的内容。
...
StdAfx.h，StdAfx.cpp
    这些文件用于生成名为 CarPlaleRec.pch 的预编译头 (PCH) 文件和
